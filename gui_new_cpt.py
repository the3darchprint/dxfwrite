...
class Ui_CPT_CSV_TO_DXF(object):
    ...
    def import_csv(self):
        ...
        points_from_csv_work = points_from_original_csv[:-9]
    ...
    def export_qc(self):
        ...
        borname=self.name_field_lineedit.text()
        ...
        msp.add_text(borname, height=2).set_placement((0, 25), align=TextEntityAlignment.MIDDLE_CENTER )
